...
if __name__ == '__main__':
    ...
    train_map = {
        ...
        8: 1.22 * np.array([7, 0]),
        9: 1.22 * np.array([8, 0]),
        10: 1.22 * np.array([9, 0])
    }

    test_map = {
        1: 1.22 * np.array([0, 0]) + 0.3 * np.array([1, 0]),
        2: 1.22 * np.array([1, 0]) + 0.3 * np.array([1, 0]),
        3: 1.22 * np.array([2, 0]) + 0.3 * np.array([1, 0]),
        4: 1.22 * np.array([3, 0]) + 0.3 * np.array([1, 0]),
        5: 1.22 * np.array([4, 0]) + 0.3 * np.array([1, 0]),
        6: 1.22 * np.array([5, 0]) + 0.3 * np.array([1, 0]),
        7: 1.22 * np.array([6, 0]) + 0.3 * np.array([1, 0]),
        8: 1.22 * np.array([7, 0]) + 0.3 * np.array([1, 0]),
        9: 1.22 * np.array([8, 0]) + 0.3 * np.array([1, 0]),
        10: 1.22 * np.array([9, 0]) + 0.3 * np.array([1, 0])
    }

    loc_num = 10
    loc_list = np.arange(1, loc_num + 1)
    loc_list_num = len(loc_list)
    f_train_path = "/data/users/c3471tl/lobby_20210621_mlp/dataset/20210621/train/"
    ...
    # loc = 1
    # csi_a = np.abs(rtrain_map_csi_a[loc])
    # plt.figure()
    # [plt.plot(csi_a[i, :]) for i in range(csi_a.shape[0])]
    # plt.show()
    ...
    # plt_loc = 9
    # csi_a = np.abs(ftrain_map_csi_a[plt_loc])
    # plt.figure()
    # [plt.plot(csi_a[i, :]) for i in range(csi_a.shape[0])]
    # # plt.show()

    # generate testing data set
    f_test_path = "/data/users/c3471tl/lobby_20210621_mlp/dataset/20210621/test/"
    ...
    # csi_a = np.abs(ftest_map_csi_a[plt_loc])
    # plt.figure()
    # [plt.plot(csi_a[i, :]) for i in range(csi_a.shape[0])]
    # plt.show()
    ...
    # create model
    f_save_path = '/data/users/c3471tl/lobby_20210621_mlp/'
    for count in range(10):
        ...
        joblib.dump(cdf_x, f_save_path + "cdf_x_mlp.save")
        joblib.dump(cdf_y, f_save_path + "cdf_y_mlp.save")
